...
#     return [rev_word_map[w] for w in s]
    
# def getMetrics(references, hypotheses):
#     bleu4 = corpus_bleu(references, hypotheses)
#     bleu3 = corpus_bleu(references, hypotheses, weights=(1.0/3, 1.0/3, 1.0/3, 0))
#     bleu2 = corpus_bleu(references, hypotheses, weights=(1.0/2, 1.0/2, 0, 0))
    


if __name__ == '__main__':
    
#     scores = nlgeval.compute_metrics(ref_list=[
#             [
